...
import com.richardkenway.cavernreborn.app.portal.CavernPortalFrameActivationService;
...
public final class CavernPortalTriggerItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        return CavernPortalFrameActivationService.activate(frameAccess, context.getClickedPos(), context.getClickedFace())
