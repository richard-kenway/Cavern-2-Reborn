...
public interface PortalFrameMaterialPolicy {
    ...
    PortalFrameMaterialPolicy MOSSY_STONE_BRICKS = state -> state.is(Blocks.MOSSY_STONE_BRICKS);
    PortalFrameMaterialPolicy CAVERN_DEFAULT = CavernPortalTags::isAllowedFrame;
