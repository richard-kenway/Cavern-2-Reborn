...
public final class ModRegistries {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CavenicWitch>> CAVENIC_WITCH = ENTITY_TYPES.register(
        "cavenic_witch",
        () -> EntityType.Builder.of(CavenicWitch::new, MobCategory.MONSTER)
            .sized(0.6F, 1.95F)
            .clientTrackingRange(8)
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CrazyZombie>> CRAZY_ZOMBIE = ENTITY_TYPES.register(
        "crazy_zombie",
        () -> EntityType.Builder.of(CrazyZombie::new, MobCategory.MONSTER)
            .sized(0.6F, 1.95F)
            .eyeHeight(1.74F)
            .passengerAttachments(2.0125F)
            .ridingOffset(-0.7F)
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CrazySkeleton>> CRAZY_SKELETON = ENTITY_TYPES.register(
        "crazy_skeleton",
        () -> EntityType.Builder.of(CrazySkeleton::new, MobCategory.MONSTER)
            .sized(0.68F, 2.0F)
            .eyeHeight(1.74F)
            .ridingOffset(-0.7F)
            .clientTrackingRange(8)
    ...
    public static final DeferredItem<Item> CRAZY_ZOMBIE_SPAWN_EGG = ITEMS.register(
        "crazy_zombie_spawn_egg",
        () -> new DeferredSpawnEggItem(() -> CRAZY_ZOMBIE.get(), 0x909090, 0x00A0A0, new Item.Properties())
    );
