...
- The legacy `attackEntityAsMob(...)` knockback branch, client particle trail and boss bar / sky-darkening updates are separate from incoming damage and remain out of scope for this slice.
