...
- actual Crazy Creeper custom fuse/explosion behavior remains manual / follow-up
...
- actual custom combat / blindness / poison behavior remains manual/follow-up
- actual long-running Crazy Spider combat/blindness/poison feel
- actual client-visible Crazy Skeleton boss-bar feel remains manual
