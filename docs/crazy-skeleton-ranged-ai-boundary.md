...
- no natural-spawn, inherited orb-drop, damage, boss-bar or particle follow-up beyond the separately restored slices documented in `docs/crazy-skeleton-loot-mvp.md`, `docs/crazy-skeleton-damage-behavior-mvp.md`, `docs/crazy-skeleton-boss-bar-mvp.md` and `docs/crazy-skeleton-particle-trail-mvp.md`
