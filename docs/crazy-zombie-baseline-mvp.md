...
- Legacy `CaveEntityRegistry` does define crazy spawn-list entries separately, but Reborn keeps the staged pattern:
  - baseline entity first
  - natural spawn rules later
  - loot, damage and special behavior later
