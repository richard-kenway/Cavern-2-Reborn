...
This note intentionally documents only the safe baseline bow slice. Legacy custom bow behavior remains follow-up work, even though the later mode-state, bounded Rapid, bounded Snipe and bounded Torch follow-ups now exist separately.
