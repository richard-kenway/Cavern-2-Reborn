...
- Crazy Skeleton boss bar / sky-darkening and particle trail remain out of scope in this slice.

## Testing

- Resource tests pin the entity-local damage hook, the exact fall/fire tag usage, the preserved `2000.0D` source literal, the preserved `1.0F` mainhand drop chance and the continued absence of natural-spawn wiring, boss-event state, particles and custom ranged-AI overrides.
